    ...
    <header className="header">
      ...
      <div className="header-static flex-spacebetween">
        <div className="header-static__left">
          <div className="flex-center hide-on-820">
            <FontAwesomeIcon
              className="header-static__left static-icon"
              icon={faCameraRetro}
            />
        ...
        <div className="header-static__right flex-center">
          <Link href={{ pathname: 'tel:84966854224' }}>
            <a className="header-static__right-setting flex-center">
              <FontAwesomeIcon
                className="header-static__left static-icon phone"
                icon={faPhoneVolume}
              />
          ...
          <Link href={{ pathname: 'mailto:sales@giangminhviet.com' }}>
            <a
              target="_blank"
              data-tip="Mail: sales@giangminhviet.com"
              className="header-static__right-login flex-center"
            >
              <FontAwesomeIcon
                className="header-static__left static-icon"
                icon={faEnvelope}
      ...
      <div className="header-dynamic flex-spacebetween">
        ...
        <Link href="/">
          <a className="header-dynamic__logo ">
            <Image
              src={ImagesPath.LOGO}
              className="header-dynamic__logo-img"
              alt="camera bac ninh logo"
            />
          </a>
        </Link>
        <div className="header-dynamic__category hide-on-992">
          <ul className="header-dynamic__category-list flex-center ">
            <li className="header-dynamic__category-item ">
              <Link href="/">
                <a
                  className={`header-dynamic__category-link ${
            ...
            <li className="header-dynamic__category-item has-dropdown">
              <Link href="/danh-muc">
                <a
                  className={`header-dynamic__category-link ${
                    router.pathname.indexOf('/danh-muc') !== -1
                      ? '--active'
                      : ''
                  }`}
                >
                  Danh mục
                  <FontAwesomeIcon
                    className="header-dynamic__down-icon"
                    icon={faAngleDown}
                  />
                </a>
              </Link>
              ...
              <ul className="header-category__children-list header__category-dropdown">
                {listCategory.map((category) => {
                  return (
                    <li
                      key={category.id}
                      className="header-category__children-item"
                    >
                      <Link href={'/danh-muc/' + category.slug}>
                        <a className="header-category__children-link">
                          {category.name}
                        </a>
                      </Link>
                    </li>
            ...
            <li className="header-dynamic__category-item ">
              <Link href="/tin-tuc">
                <a
                  className={`header-dynamic__category-link ${
                    router.pathname.indexOf('/tin-tuc') !== -1 ? '--active' : ''
                  }`}
                >
                  Tin tức
                </a>
            ...
            <li className="header-dynamic__category-item ">
              <Link href="/lien-he">
                <a
                  className={`header-dynamic__category-link ${
                    router.pathname.indexOf('/lien-he') !== -1 ? '--active' : ''
                  }`}
                >
                  Liên hệ
                </a>
      ...
      >
        <div className="category-menu__title ">
          ...
          <div
            ...
            className="category-menu__title-close"
          >
        ...
        <ul className="category-menu__list ">
          <li className="category-menu__item ">
            <Link href="/">
              <a href=" " className="category-menu__link ">
                Trang chủ
              </a>
            </Link>
          </li>
          <li className="category-menu__item dropdown">
            <div
              className="category-menu__link dropdown"
              ...
              <ul className="category-menu__dropdown">
                {listCategory.map((category) => {
                  return (
                    <li
                      key={category.id}
                      className="category-menu__dropdown-item"
                      onClick={() => {
                        setCategoryIsOpen(false);
                      }}
                    >
                      <Link href={category.slug}>
                        <a className="category-menu__dropdown-link">
                          {category.name}
                        </a>
                      </Link>
                    </li>
          ...
          <li className="category-menu__item --search show-on-576-flex">
            ...
            <input
              ...
              onKeyDown={handlePressEnter}
              onChange={searchParamsChange}
              className="category-menu__item-search"
              type="text"
              placeholder="Tìm kiếm sản phẩm..."
            />
          </li>
