    ...
    <>
      ...
      <Layout>
        <div className="product">
          ...
          <Row>
            <Col>
              <div className="product__detail-name">{detailProduct.name}</div>
            </Col>
          </Row>
          <Row className="product__detail">
            ...
            <Col xs={12} md={5}>
              ...
              <div className="product__detail-sale">
                ...
                <ul className="product__detail-sale-list">
                  ...
                  <li className="product__detail-sale-item">
                    ...
                    MIỄN PHÍ cài đặt và hướng dẫn sử dụng tận nơi
                  </li>
                  <li className="product__detail-sale-item">
                    <div className="product__detail-sale-icon">
                      <FontAwesomeIcon icon={faCheckCircle} />
              ...
              <div className="product__detail-special">
                ...
                <div
                  className="product__detail-short-desc"
              ...
              <div className="product__detail-contact">
                <div
                  ...
                  className="product__detail-contact-link"
                >
                  Liên hệ ngay
                </div>
              </div>
                ...
                <div className="product__shop-reason">
                  ...
                  <ul className="product__shop-reason-list">
                    <li className="product__shop-reason-item">
                      ...
                      Hotline hỗ trợ: <strong>0986 795 960</strong>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          {detailProduct.detail && (
            <Row>
              <Col lg={8} className="product__description">
                <div
                  dangerouslySetInnerHTML={{ __html: detailProduct.detail }}
                ></div>
              </Col>
              {listPost.length > 0 && (
                <Col lg={4} className="product__news">
                  <div className="product__news-title">Tin tức mới</div>
                              ...
                              <Row className="product__news-row">
                                ...
                                <Col lg={9}>
                                  ...
                                  <div className="product__news-date">
                                    <FontAwesomeIcon
                                      className="product__news-date-icon"
                                      icon={faCalendarAlt}
                                    />
                                    <div className="product__news-date-product">
                                      {post.update_at}
                                    </div>
                                  </div>
                                </Col>
          ...
          <Row className="product__contact-form">
            <div className="product__contact-form-header">
      ...
      >
        <div className="contact-form__header">
          ...
          <div
            ...
            className="contact-form__header-close"
          >
...
export async function getServerSideProps(context) {
  ...
  try {
    ...
    detailCategory = await categoryService.detailCategoryById(
      detailProduct.data.category_id,
    );
    detailProduct.data = {
      ...detailProduct.data,
      category_name: detailCategory.data.name || '',
      category_slug: detailCategory.data.slug,
    };
    relatedProducts = await productService.listProductByCategoryId(
      detailProduct.data.category_id,
    );
